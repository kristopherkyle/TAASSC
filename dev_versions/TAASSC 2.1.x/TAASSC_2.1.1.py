...
try1 = BTR_Analysis("This is an attempt at creating a super cool sentence with lots of features. This is a second one.", index_list,cats)
...
print_vertical(try1["tagged_text"]) #pretty-print tags
output_vertical(try1["tagged_text"],"try1.tsv",ordered_output = "full") #write vertical output to file
output_xml(try1["tagged_text"],"try1.xml") #write xml output to file

try2 = BTR_Analysis("They said she liked hamburgers. They also said that he didn't.",index_list,cats)
print_vertical(try2["tagged_text"]) #pretty-print tags
